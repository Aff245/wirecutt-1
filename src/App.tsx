...
import SmartAffiliateButton from './components/SmartAffiliateButton';
import AIRecommendations from './components/Enhanced/AIRecommendations';
import Testimonials from './components/Enhanced/Testimonials';
